...
CREATE TABLE usuarios_post(
    ...
    CONSTRAINT PK_id_usuarios_post PRIMARY KEY (id),
    FOREIGN KEY  id_usuarios REFERENCES id_usuarios(id_usuarios),
    FOREIGN KEY  id_post REFERENCES id_post(id_post)
...
CREATE TABLE post_resenia(
    ...
    CONSTRAINT PK_id_post_resenia PRIMARY KEY (id),
    FOREIGN KEY  id_post REFERENCES id_post(id_post),
    FOREIGN KEY  id_resenia REFERENCES id_resenia(id_resenia)
);
...
CREATE TABLE resenia(
    ...
    id_usuarios INT NOT NULL,
    CONSTRAINT PK_id_resenia PRIMARY KEY (id),
    FOREIGN KEY  id_usuarios REFERENCES id_usuarios(id_usuarios)
);
...
CREATE TABLE resenia_comentario(
    ...
    CONSTRAINT PK_id_resenia_comentario PRIMARY KEY (id),
    FOREIGN KEY  id_resenia REFERENCES id_resenia(id_resenia),
    FOREIGN KEY  id_comentario REFERENCES id_comentario(id_comentario)
);
