...
var btnPlayGera = document.getElementById("playGera");
var btnStop = document.getElementById("stop");
var btnReplay = document.getElementById("replay");
//Image
var cover = document.querySelector(".cover");
//Element audio
var audioGera = document.getElementById("audioGera");
//Icon play and pause
...
function playMusicGera() {
	cover.setAttribute("class", "playGera");
...
//---------------- Play music
btnPlayGera.addEventListener("click", () => {
	playMusicGera();
